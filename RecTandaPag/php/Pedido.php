...
class PedidoModel{
    ...
    function AddPedido($id_ciudadano,$id_pedido,$franja_horaria_inicio,$franja_horaria_fin,$tipo_volumen,$imagen_materiales){
        $sentencia = $this->db->prepare("INSERT INTO pedido(id_ciudadano,id_pedido,franja_horaria_inicio,franja_horaria_fin,tipo_volumen,imagen_materiales) VALUES(?,?,?,?,?,?)");
